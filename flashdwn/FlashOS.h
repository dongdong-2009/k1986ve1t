...
struct SECTOR_INFO  {
  ...
  U32 SectorStartAddr;  // Start address of the sector area
};
...
extern int BlankCheck  (U32 Addr, U32 Size, U32 Pat);
extern int EraseChip   (void);
extern int EraseSector (U32 Addr);
extern int ProgramPage (U32 Addr, U32 Size, U8 *pSrcBuff);
extern U32 Verify      (U32 Addr, U32 Size, U8 *pSrcBuff);
