...
typedef struct {
  __IO uint16_t ETH_Dilimiter;
  __IO uint16_t ETH_MAC_T;
  __IO uint16_t ETH_MAC_M;
  __IO uint16_t ETH_MAC_H;
  __IO uint16_t ETH_HASH0;
  __IO uint16_t ETH_HASH1;
  __IO uint16_t ETH_HASH2;
  __IO uint16_t ETH_HASH3;
  __IO uint16_t ETH_IPG;
  __IO uint16_t ETH_PSC;
  __IO uint16_t ETH_BAG;
  __IO uint16_t ETH_JitterWnd;
  __IO uint16_t ETH_R_CFG;
  __IO uint16_t ETH_X_CFG;
  __IO uint16_t ETH_G_CFG;
       uint16_t RESERVED0;
  __IO uint16_t ETH_IMR;
  __IO uint16_t ETH_IFR;
  __IO uint16_t ETH_MDIO_DATA;
  __IO uint16_t ETH_MDIO_CTRL;
  __IO uint16_t ETH_R_Head;
  __IO uint16_t ETH_X_Tail;
  __IO uint16_t ETH_R_Tail;
  __IO uint16_t ETH_X_Head;
  __IO uint16_t ETH_Buff_Stat;
} ETHERNET_TypeDef;
