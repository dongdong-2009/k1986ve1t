...
#ifndef __OPORA_BKP_DEFS_H
#define __OPORA_BKP_DEFS_H
...
#define BKP_REG_0E_LOW_OFFS                     0
#define BKP_REG_0E_LOW_MASK                     ((uint32_t)0x00000007)

#define BKP_REG_0E_SelectRI_OFFS                3
#define BKP_REG_0E_SelectRI_MASK                ((uint32_t)0x00000038)

#define BKP_REG_0E_JTAGA_OFFS                   6
#define BKP_REG_0E_JTAGA                        ((uint32_t)0x00000040)

#define BKP_REG_0E_JTAGB_OFFS                   7
#define BKP_REG_0E_JTAGB                        ((uint32_t)0x00000080)

#define BKP_REG_0E_Trim_OFFS                    8
#define BKP_REG_0E_Trim_MASK                    ((uint32_t)0x00000700)

#define BKP_REG_0E_FPOR_OFFS                    11
#define BKP_REG_0E_FPOR                         ((uint32_t)0x00000800)

#define BKP_REG_0E_BKP_REG_OFFS                 12
#define BKP_REG_0E_BKP_REG_MASK                 ((uint32_t)0xFFFFF000)
...
#define BKP_REG_0F_LSE_ON_OFFS                  0
#define BKP_REG_0F_LSE_ON                       ((uint32_t)0x00000001)

#define BKP_REG_0F_LSE_BYP_OFFS                 1
#define BKP_REG_0F_LSE_BYP                      ((uint32_t)0x00000002)

#define BKP_REG_0F_RTC_SEL_OFFS                 2
#define BKP_REG_0F_RTC_SEL_MASK                 ((uint32_t)0x0000000C)

#define BKP_REG_0F_RTC_EN_OFFS                  4
#define BKP_REG_0F_RTC_EN                       ((uint32_t)0x00000010)

#define BKP_REG_0F_CAL_OFFS                     5
#define BKP_REG_0F_CAL_MASK                     ((uint32_t)0x00001FE0)

#define BKP_REG_0F_LSE_RDY_OFFS                 13
#define BKP_REG_0F_LSE_RDY                      ((uint32_t)0x00002000)

#define BKP_REG_0F_BKP_REG_OFFS                 14
#define BKP_REG_0F_BKP_REG                      ((uint32_t)0x00004000)

#define BKP_REG_0F_LSI_ON_OFFS                  15
#define BKP_REG_0F_LSI_ON                       ((uint32_t)0x00008000)

#define BKP_REG_0F_LSI_TRIM_OFFS                16
#define BKP_REG_0F_LSI_TRIM_MASK                ((uint32_t)0x001F0000)

#define BKP_REG_0F_LSI_RDY_OFFS                 21
#define BKP_REG_0F_LSI_RDY                      ((uint32_t)0x00200000)

#define BKP_REG_0F_HSI_ON_OFFS                  22
#define BKP_REG_0F_HSI_ON                       ((uint32_t)0x00400000)

#define BKP_REG_0F_HSI_RDY_OFFS                 23
#define BKP_REG_0F_HSI_RDY                      ((uint32_t)0x00800000)

#define BKP_REG_0F_HSI_TRIM_OFFS                24
#define BKP_REG_0F_HSI_TRIM_MASK                ((uint32_t)0x3F000000)

#define BKP_REG_0F_STANDBY_OFFS                 30
#define BKP_REG_0F_STANDBY                      ((uint32_t)0x40000000)

#define BKP_REG_0F_RTC_RESET_OFFS               31
...
#endif /* __OPORA_BKP_DEFS_H */

/******************* (C) COPYRIGHT 2010 Phyton *********************************
*
* END OF FILE opora_bkp_defs.h */
